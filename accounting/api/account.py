...
from accounting.schemas import AccountOut, CurrencyBalance, FourOFourOut, GeneralLedgerOut
from typing import List
from django.db.models import Sum, Avg
from rest_framework import status
from restauth.authorization import AuthBearer
from accounting.models import Balance
...
def get_total_balance(request, account_id: int):
    ...
    if  account.children.all() == []: 
        total_balances = Balance(account.balance())
        ...
        total_balances =  Balance(parent_balance) + Balance(balance1) + Balance(balance2)
